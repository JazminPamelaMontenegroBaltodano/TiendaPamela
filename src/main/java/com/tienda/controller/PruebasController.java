...
public class PruebasController {
    ...
    @PostMapping("query4")
    public String findByDescripcion(@RequestParam String descripcion, Model model) {
        List<Producto> productos = productoService.findByDescripcion(descripcion);
        model.addAttribute("productos", productos);
        return "pruebas/fragmentos";
    }
